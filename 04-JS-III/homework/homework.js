...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Escribe tu código aquí
  var esDiaLaboral = 'Es dia Laboral';
  var esFinSemana = 'Es fin de semana';   
  var diasSemana = [esFinSemana, esDiaLaboral, esDiaLaboral, esDiaLaboral, esDiaLaboral, esDiaLaboral, esFinSemana];
  return diasSemana[numeroDeDia - 1];
} 
